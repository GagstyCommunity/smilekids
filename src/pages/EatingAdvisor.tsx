      ...
      <main className="container py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 grid md:grid-cols-[1fr_220px] gap-6 items-center">
            ...
            <img src={new URL("@/assets/eating-advisor.jpg", import.meta.url).href} alt="Tooth-friendly foods" loading="lazy" width={440} height={440} className="rounded-2xl object-cover w-full aspect-square shadow-card hidden md:block" />
          </div>
